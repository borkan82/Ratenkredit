...
class IngDibaClient implements LoanOfferClient {
    ...
    // These are original data, but the URL is not working anymore
    ...
    /**
     * Fetching IngDiba Data from API
     *
     * @param int $amount
     *
    ...
    public function fetch(int $amount): ?LoanOffer {
        ...
        return new LoanOffer(provider: LoanProvider::IngDiba, interestRate: (float) $data['zinsen'], durationMonths: $durationMonth);
    }
}